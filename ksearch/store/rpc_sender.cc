...
namespace ksearch {
    ...
    int RpcSender::get_peer_binlog_oldest_ts(const std::string &instance, const pb::StoreReq &request,
                                             int64_t &oldest_ts) {
        pb::StoreRes response;
        StoreReqOptions req_options;
    ...
    int RpcSender::get_peer_offline_binlog_info(const std::string &instance, const pb::StoreReq &req,
                                                pb::StoreRes &res) {
        StoreReqOptions req_options;
        req_options.request_timeout = 10000; // 10s
        req_options.connect_timeout = 10000; // 10s
