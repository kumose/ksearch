...
namespace ksearch {
    ...
    public:
        ...
        static int get_peer_binlog_oldest_ts(const std::string &instance, const pb::StoreReq &request,
                                             int64_t &oldest_ts);

        static int get_peer_offline_binlog_info(const std::string &instance, const pb::StoreReq &req,
                                                pb::StoreRes &res);
    };
} // end of namespace