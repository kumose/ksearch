...
namespace ksearch {
    ...
    struct ColumnSchemaInfo {
        ...
        // 包含表中所有字段 + __key_type__; 顺序为key + value + __key_type__; key为主键序，value为非主键字段按field_idx顺序
        std::shared_ptr<arrow::Schema> schema_with_order_info = nullptr;
        // 比schema多包含__raft_index__, __batch_pos__放在__key_type__后面
    };
    ...
    public:
        ...
        static bool TEST_record_batch_diff(const std::shared_ptr<arrow::RecordBatch> &rb1,
