...
namespace ksearch {
    ...
    public:
        ...
        arrow::Status write_batch(const std::shared_ptr<arrow::RecordBatch> &record_batch,
                                  const RecordBatchInfo &rb_info);

        arrow::Status write_rowgroup(const std::vector<std::shared_ptr<arrow::RecordBatch> > &record_batchs,
    ...
    public:
        ...
        arrow::Status execute(std::unique_ptr<arrow::RecordBatchReader> input, ColumnCompactionType type,
    ...
    private:
        arrow::Status execute_do(std::unique_ptr<arrow::RecordBatchReader> input, ColumnCompactionType type,
                                 const std::function<bool ()> &cancel);
