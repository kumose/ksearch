...
namespace ksearch {
    ...
    private:
        ColumnVars() : minor_compaction_write_rows_per_second("column_minor_compaction_write_rows_per_second",
                                                              &minor_compaction_write_rows),
                       major_compaction_write_rows_per_second("column_major_compaction_write_rows_per_second",
                                                              &major_compaction_write_rows),
                       base_compaction_write_rows_per_second("column_base_compaction_write_rows_per_second",
                                                             &base_compaction_write_rows),
                       cumulative_file_max_count_minute("column_cumulative_file_max_count_minute",
                                                        &cumulative_file_max_count, 60),
