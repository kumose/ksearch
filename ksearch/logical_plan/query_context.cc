...
namespace ksearch {
    ...
    int QueryContext::copy_query_context(QueryContext *p_query_ctx) {
        ...
        table_partition_names.insert(p_query_ctx->table_partition_names.begin(),
                                     p_query_ctx->table_partition_names.end());
        table_version_map.insert(p_query_ctx->table_version_map.begin(), p_query_ctx->table_version_map.end());
        table_with_clause_mapping.insert(p_query_ctx->table_with_clause_mapping.begin(),
                                         p_query_ctx->table_with_clause_mapping.end());
