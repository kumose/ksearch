...
namespace ksearch {
    ...
    public:
        ...
        static int update_specify_split_keys(const std::string &ns, const std::string &db, const std::string &tbl,
    ...
    private:
        ...
        int add_column_def(pb::SchemaInfo &table, parser::ColumnDef *column,
                           bool is_unique_indicator, bool is_modify_field = false,
        ...
        bool is_fulltext_type_constraint(pb::StorageType pb_storage_type, bool &has_arrow_type,
                                         bool &has_pb_type) const;

        pb::PrimitiveType to_ks_type(parser::FieldType *field_type);
