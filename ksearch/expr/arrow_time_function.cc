 ...
 */
    ...
    int arrow_date_format(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("ks_date_format", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_time_format(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        CommonFunctionOptions option(children[1]->get_value(nullptr).get_string());
        out = arrow::compute::call("ks_time_format", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_hour(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("ks_hour", {children[0]->arrow_expr()});
        return 0;
    }
    ...
    int arrow_date_sub(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("ks_date_sub", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_date_add(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        std::string unit = children[2]->get_value(nullptr).get_string();
        CommonFunctionOptions option(unit, interval);
        out = arrow::compute::call("ks_date_add", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_time_to_sec(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("ks_time_to_sec", {children[0]->arrow_expr()});
        return 0;
    }
    ...
    int arrow_week(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("ks_week", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_yearweek(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        CommonFunctionOptions option("", mode);
        out = arrow::compute::call("ks_yearweek", {children[0]->arrow_expr()}, std::move(option));
        return 0;
    }
    ...
    int arrow_timestampdiff(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("subtract_checked", {
                                       arrow_cast(children[2]->arrow_expr(), pb::TIMESTAMP, pb::INT64),
    ...
    int arrow_datediff(std::vector<ExprNode *> &children, pb::Function *fn, const pb::PrimitiveType &return_type,
        ...
        out = arrow::compute::call("subtract_checked", {
                                       arrow_cast(left, pb::TIMESTAMP, pb::INT64),
 ...
 */
     ...
     */
        {
            auto arrow_date_format = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_date_format", arrow::compute::Arity::Unary(),
            ...
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    arrow_date_format->AddKernel({in_ty}, arrow::large_binary(),
                                                 arrow::compute::internal::GenerateNumeric<ExecDateFormat,
                                                     arrow::LargeBinaryType>(*in_ty),
                                                 InitCommonState));
            }
     ...
     */
        {
            auto arrow_time_format = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_time_format", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    arrow_time_format->AddKernel({in_ty}, arrow::large_binary(),
                                                 arrow::compute::internal::GenerateNumeric<ExecTimeFormat,
                                                     arrow::LargeBinaryType>(*in_ty),
                                                 InitCommonState));
            }
     ...
     */
        {
            auto arrow_hour = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_hour", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    arrow_hour->AddKernel({in_ty}, arrow::uint32(),
                                          arrow::compute::internal::GenerateNumeric<ExecHour,
                                              arrow::UInt32Type>(*in_ty),
                                          InitCommonState));
            }
     ...
     */
        {
            auto arrow_date_sub = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_date_sub", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    arrow_date_sub->AddKernel({in_ty}, arrow::uint64(),
                                              arrow::compute::internal::GenerateNumeric<ExecDateSub, arrow::UInt64Type>(
                                                  *in_ty),
                                              InitCommonState));
            }
     ...
     */
        {
            auto arrow_date_add = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_date_add", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    arrow_date_add->AddKernel({in_ty}, arrow::uint64(),
                                              arrow::compute::internal::GenerateNumeric<ExecDateAdd, arrow::UInt64Type>(
                                                  *in_ty),
                                              InitCommonState));
            }
     ...
     */
        {
            auto time_to_sec = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_time_to_sec", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                ARROW_RETURN_NOT_OK(
                    time_to_sec->AddKernel({in_ty}, arrow::uint32(),
                                           arrow::compute::internal::GenerateNumeric<ExecTimeToSec, arrow::UInt32Type>(
                                               *in_ty),
                                           InitCommonState));
            }
     ...
     */
        {
            auto week_func = std::make_shared<arrow::compute::ScalarFunction>("ks_week", arrow::compute::Arity::Unary(),
                                                                              /*doc=*/
                                                                              arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                arrow::compute::ScalarKernel kernel({in_ty}, arrow::uint32(),
                                                    arrow::compute::internal::GenerateNumeric<ExecWeek,
                                                        arrow::UInt32Type>(*in_ty),
                                                    InitCommonState);
     ...
     */
        {
            auto yearweek_func = std::make_shared<arrow::compute::ScalarFunction>(
                "ks_yearweek", arrow::compute::Arity::Unary(),
                /*doc=*/arrow::compute::FunctionDoc::Empty());
            for (const std::shared_ptr<arrow::DataType> &in_ty: arrow::NumericTypes()) {
                arrow::compute::ScalarKernel kernel({in_ty}, arrow::uint32(),
                                                    arrow::compute::internal::GenerateNumeric<ExecYearWeek,
                                                        arrow::UInt32Type>(*in_ty),
                                                    InitCommonState);
                kernel.null_handling = arrow::compute::NullHandling::COMPUTED_PREALLOCATE;
                kernel.mem_allocation = arrow::compute::MemAllocation::PREALLOCATE;
