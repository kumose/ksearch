...
namespace ksearch {
    ...
    private:
        ...
        int add_exchange_and_separate(QueryContext *ctx, SmartFragment &fragment, ExecNode *node,
        ...
        int seperate_db_fragment(QueryContext *ctx, SmartFragment &fragment, ExecNode *node,
                                 NodePartitionProperty *parent_property);

        int check_need_add_exchange(NodePartitionProperty *parent_propety, NodePartitionProperty *node_property,
                                    bool *need_add_exchange);
