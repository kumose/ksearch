...
#include <ksearch/exec/sort_node.h>
#include <ksearch/exec/filter_node.h>
#include <ksearch/exec/full_export_node.h>
#include <ksearch/exec/insert_node.h>
#include <ksearch/exec/transaction_node.h>
#include <ksearch/exec/begin_manager_node.h>
#include <ksearch/exec/commit_manager_node.h>
#include <ksearch/exec/rollback_manager_node.h>
#include <ksearch/exec/insert_manager_node.h>
#include <ksearch/exec/update_manager_node.h>
#include <ksearch/exec/delete_manager_node.h>
#include <ksearch/exec/common_manager_node.h>
#include <ksearch/exec/select_manager_node.h>
#include <ksearch/exec/union_node.h>
#include <ksearch/exec/single_txn_manager_node.h>
#include <ksearch/exec/lock_primary_node.h>
...
namespace ksearch {
    ...
    int Separate::separate_simple_select(QueryContext *ctx, ExecNode *plan) {
        ...
        std::vector<ExecNode *> scan_nodes;
        plan->get_node(pb::SCAN_NODE, scan_nodes);
        SelectManagerNode *manager_node_inter = static_cast<SelectManagerNode *>(plan->
            get_node(pb::SELECT_MANAGER_NODE));
 ...
 */
    ...
    int Separate::create_lock_node(
        ...
        global_affected_indexs.insert(global_affected_indexs.end(), global_unique_indexs.begin(),
                                      global_unique_indexs.end());
        global_affected_indexs.insert(global_affected_indexs.end(), global_non_unique_indexs.begin(),
                                      global_non_unique_indexs.end());
 ...
 */
    ...
    int Separate::separate_single_txn(QueryContext *ctx, T *node, pb::OpType op_type) {
        ...
        std::unique_ptr<TransactionNode> store_begin_node(
            create_txn_node(pb::TXN_BEGIN_STORE, ctx->user_info->txn_lock_timeout));
