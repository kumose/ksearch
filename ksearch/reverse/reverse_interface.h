...
#include <ksearch/reverse/boolean_engine/logical_query.h>
...
namespace ksearch {
    ...
    public:
        ...
        CommRindexNodeParser(Schema *schema) : RindexNodeParser<Schema>(schema) {
...
#include <ksearch/reverse/reverse_interface.hpp>