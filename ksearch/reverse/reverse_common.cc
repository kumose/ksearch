...
namespace ksearch {
    ...
    DEFINE_string(punctuation_path, "./conf/punctuation.dic",
                  "Path to punctuation dictionary, default: ./conf/punctuation.dic");
    ...
    std::vector<Tokenizer::SeperateIndex> Tokenizer::q2b_tolower_with_index(
        std::string &word, const pb::Charset &charset) {
        switch (charset) {
            case pb::GBK:
