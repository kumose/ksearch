...
#pragma once
#include <ksearch/reverse/reverse_arrow.h>
#include <map>
...
#include <ksearch/reverse/boolean_engine/boolean_executor.h>
...
namespace ksearch {
    ...
    public:
        FirstLevelMSIterator(
            ...
            myrocksdb::Transaction *txn = NULL) : _iter(iter),
    ...
    public:
        SecondLevelMSIterator(ReverseList &list, const KeyRange &key_range) : _list(list),
                                                                              _key_range(key_range),
                                                                              _index(0),
                                                                              _first(true) {
        }
...
#include <ksearch/reverse/reverse_common.hpp>