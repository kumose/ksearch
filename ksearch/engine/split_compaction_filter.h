...
namespace ksearch {
    ...
    class SplitCompactionFilter : public rocksdb::CompactionFilter {
        struct FilterRegionInfo {
            FilterRegionInfo(bool use_normal_ttl, const std::string &end_key,
                             int64_t online_ttl_base_expire_time_us) : use_normal_ttl(use_normal_ttl), end_key(end_key),
                                                                       online_ttl_base_expire_time_us(
                                                                           online_ttl_base_expire_time_us) {
            }
    ...
    public:
        ...
        void set_filter_region_info(int64_t region_id, const std::string &end_key,
            ...
            auto call = [region_id, end_key, use_normal_ttl, online_ttl_base_expire_time_us](KeyMap &key_map) {
                FilterRegionInfo *new_info = new FilterRegionInfo(use_normal_ttl, end_key,
                                                                  online_ttl_base_expire_time_us);
