...
#include <ksearch/common/item_batch.hpp>
#include <ksearch/engine/my_rocksdb.h>
...
namespace ksearch {
    ...
    struct IndexRange {
        ...
        IndexRange(const MutTableKey &_left,
                   ...
                   bool _l_open,
                   bool _r_open,
                   bool _like_prefix) : left_key(_left),
                                        right_key(_right),
    ...
    class Iterator {
    public:
        Iterator(bool need_check_region, bool forward) : _need_check_region(need_check_region),
                                                         _forward(forward) {
        }
    ...
    public:
        TableIterator(bool need_check_region, bool forward, KVMode mode = KEY_VAL) : Iterator(need_check_region,
                forward), _mode(mode) {
        }
    ...
    public:
        IndexIterator(bool need_check_region, bool forward) : Iterator(need_check_region, forward) {
        }
