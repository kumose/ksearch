...
namespace ksearch {
    ...
    public:
        ...
        void leader_load_balance_on_pk_prefix(const std::string &instance,
                                              ...
                                              std::unordered_map<int64_t, std::unordered_map<std::string, std::vector<
                                                  int64_t> > > &pk_prefix_leader_region_map,
    ...
    public:
        ...
        int64_t get_all_region_max_binlog_times(int64_t table_id) {
            ...
            _binlog_region_state_map.traverse_with_key_value(
                [&table_id, &max_binlog_times](int64_t region_id, BinlogRegionState &state) {
