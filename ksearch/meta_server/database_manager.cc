...
namespace ksearch {
    ...
    void DatabaseManager::drop_privilege_for_database(const pb::MetaManagerRequest &request,
    ...
    void DatabaseManager::process_ks_heartbeat(const pb::KsHeartBeatRequest *request,
