...
namespace ksearch {
        ...
        *(response->add_schema_infos()) = schema_pb;
        ...
        for (auto &index_info: schema_pb.indexs()) {
            ...
            for (auto &field_name: index_info.field_names()) {
                ...
                auto type = QueryTableManager::get_instance()->
                        get_field_type(schema_pb.table_id(), field_id, schema_pb);
    ...
    void QueryTableManager::get_virtual_index_influence_info(const pb::QueryRequest *request,
                                                             pb::QueryResponse *response) {
