...
namespace ksearch {
    ...
    DEFINE_int32(ks_faulty_interval_times, 3, "ks faulty interval times of heart beat");
    DEFINE_int32(ks_clear_faulty_interval_times, 30, "ks clear faulty instances interval times of heart beat");
}