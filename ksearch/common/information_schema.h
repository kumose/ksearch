...
namespace ksearch {
    ...
    private:
        ...
        void query_regions_concurrency(
        ...
        void process_binlogs_region_info(std::vector<std::vector<std::string> > &result_rows,
