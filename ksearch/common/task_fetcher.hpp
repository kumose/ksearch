namespace ksearch {
    ...
    int TaskFactory<TaskType>::process_heartbeat(const pb::KsHeartBeatResponse &response,
                                                 const google::protobuf::RepeatedPtrField<TaskType> &(
                                                     pb::KsHeartBeatResponse::*method)() const) {
    ...
    template<typename TaskType>
    int TaskFactory<TaskType>::construct_heartbeat(pb::KsHeartBeatRequest & request,
                                                   TaskType * (pb::KsHeartBeatRequest:: * method)()) {
        BAIDU_SCOPED_LOCK(_mutex);
