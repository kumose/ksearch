...
namespace ksearch {
    ...
    DECLARE_int32 (ks_heartbeat_concurrency);
    ...
    struct Concurrency {
        ...
        BthreadCond ks_heartbeat_concurrency;
        BthreadCond ks_other_heartbeat_concurrency;
    ...
    private:
        Concurrency() : snapshot_load_concurrency(-FLAGS_snapshot_load_num),
                        ...
                        ks_heartbeat_concurrency(-FLAGS_ks_heartbeat_concurrency),
                        ks_other_heartbeat_concurrency(-FLAGS_ks_heartbeat_concurrency),
