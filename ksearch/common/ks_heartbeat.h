...
namespace ksearch {
    ...
    public:
        ...
        static void construct_heart_beat_request(
            pb::KsHeartBeatRequest &request, bool is_backup = false, bool is_binlog = false);
        ...
        static void process_heart_beat_response_sync(
            const pb::KsHeartBeatResponse &response, const int64_t meta_id = 0);

        static void process_heart_beat_response(
            const pb::KsHeartBeatResponse &response, bool is_backup = false, const int64_t meta_id = 0);
    };

    class BaseKsHeartBeat {
    public:
        virtual ~BaseKsHeartBeat() {
        }

        static BaseKsHeartBeat *get_instance() {
            static BaseKsHeartBeat instance;
            return &instance;
        }
    ...
    public:
        ...
        void process_heart_beat_response(const pb::KsHeartBeatResponse &response);

        bool process_heart_beat_response_sync(const pb::KsHeartBeatResponse &response);
