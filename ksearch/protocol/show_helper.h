...
#include <ksearch/protocol/mysql_wrapper.h>
...
const std::string SQL_SHOW_INSULATE_FETCHER_RESOURCE_TAG = "insulate_fetcher_resource_tag";
// show insulate_fetcher_resource_tag;
...
namespace ksearch {
    ...
    private:
        ...
        bool _handle_client_query_template_dispatch(const SmartSocket &client,
                                                    const std::vector<std::string> &split_vec);
        ...
        inline ResultField make_result_field(const std::string &name, const uint8_t &type,
