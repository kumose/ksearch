...
#             bns                                user        password
    'group.opera-ps-ksearch-000-bj.FENGCHAO.all ks_user 59ACp2Bl#'
    'group.opera-ps-ksearch-000-ct.FENGCHAO.all ks_user 59ACp2Bl#'
    'group.opera-e0-ksearch-000-yz.FENGCHAO.all root        root'
)
