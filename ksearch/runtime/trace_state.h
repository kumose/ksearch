...
namespace ksearch {
    ...
    public:
        TraceLocalNode(const char *desc,
                       ...
                       std::function<void(TraceLocalNode &)> exit_func) : _description(desc),
        ...
        static std::string print_declaration(const arrow::acero::Declaration &dec,
                                             std::shared_ptr<arrow::Schema> source_schema = nullptr,
                                             bool *info = nullptr) {
        ...
        void add_arrow_plan(const arrow::acero::Declaration &dec,
                            std::shared_ptr<arrow::Schema> source_schema = nullptr, bool *info = nullptr) {
            if (_trace_node != nullptr) {
