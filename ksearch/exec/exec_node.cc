...
#include <ksearch/exec/update_node.h>
#include <ksearch/exec/delete_node.h>
...
#include <ksearch/exec/truncate_node.h>
#include <ksearch/exec/kill_node.h>
...
#include <ksearch/exec/apply_node.h>
#include <ksearch/exec/load_node.h>
...
namespace ksearch {
    ...
    int ExecNode::push_cmd_to_cache(RuntimeState *state,
        ...
        // cache dml cmd in ksearch before sending to store
    ...
    bool ExecNode::shrink_partition_property(std::shared_ptr<HashPartitionColumns> my_hash_columns,
                                             NodePartitionProperty *child_partition_property) {
