...
namespace ksearch {
    ...
    public:
        AceroBaseNode(arrow::acero::ExecPlan *plan, std::vector<arrow::acero::ExecNode *> inputs,
        ...
        // for ordered input
        arrow::Result<std::optional<arrow::acero::util::SequencingQueue::Task> >
        Process(arrow::ExecBatch batch) override;
