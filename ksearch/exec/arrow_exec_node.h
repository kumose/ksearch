...
#include <ksearch/exec/acero_base_node.h>
...
namespace ksearch {
    ...
    public:
        IndexCollecterNode(arrow::acero::ExecPlan *plan, std::vector<arrow::acero::ExecNode *> inputs,
    ...
    public:
        UnorderedFetchNode(arrow::acero::ExecPlan *plan, std::vector<arrow::acero::ExecNode *> inputs,
                           std::shared_ptr<arrow::Schema> output_schema,
        ...
        std::string ToStringExtra(int indent = 0) const override {
            return "UnorderedFetchNode, offset=" + std::to_string(_offset_cnt) + "  limit=" +
                   std::to_string(_limit_cnt);
        }
