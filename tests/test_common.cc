...
namespace ksearch {
    ...
    TEST(test_TimePeriodChecker, timechecker) {
        ksearch::RocksWrapper *_rocksdb = RocksWrapper::get_instance();
    ...
    TEST(regex_test, re2_regex) {
        ...
        option.set_encoding(re2::RE2::Options::EncodingLatin1);;
    ...
    TEST(test_gbk_regex, match) {
        ...
        //如何避免无效点击和恶意点击 gbk码点
        std::string val1{
            "\xC8\xE7\xBA\xCE\xB1\xDC\xC3\xE2\xCE\xDE\xD0\xA7\xB5\xE3\xBB\xF7\xBA\xCD\xB6\xF1\xD2\xE2\xB5\xE3\xBB\xF7"
        };
        // char匹配
    ...
    TEST(bns_to_meta_bns_test, case_all) {
        static std::map<std::string, std::string> mapping = {
            {"28.opera-atomkv-ksStore-000-bj.FENGCHAO.bjhw", "group.opera-atomkv-ksMeta-000-bj.FENGCHAO.all"},
            {"2.opera-bigtree-ksStore-000-bj.FENGCHAO.bjyz", "group.opera-atomkv-ksMeta-000-bj.FENGCHAO.all"},
            {"5.opera-coffline-ksStore-000-mix.FENGCHAO.dbl", "group.opera-coffline-ksMeta-000-bj.FENGCHAO.all"},
            {"83.opera-p1-ksStore-000-bj.HOLMES.bjhw", "group.opera-online-ksMeta-000-bj.HOLMES.all"},
            {"45.opera-xinghe2-ksStore-000-bj.DMP.bjhw", "group.opera-online-ksMeta-000-bj.DMP.all"},
            {"0.opera-adp-ksearch-000-bj.FENGCHAO.bjyz", "group.opera-ps-ksMeta-000-bj.FENGCHAO.all"},
            {"0.opera-atomkv-ksearch-000-bj.FENGCHAO.bjyz", "group.opera-atomkv-ksMeta-000-bj.FENGCHAO.all"},
            {"group.opera-atomkv-ksearch-000-bj.FENGCHAO.all", "group.opera-atomkv-ksMeta-000-bj.FENGCHAO.all"},
            {"group.opera-detect-ksearch-000-gz.FENGCHAO.all", "group.opera-detect-ksMeta-000-bj.FENGCHAO.all"},
            {"group.opera-e0-ksearch-000-ct.FENGCHAO.all", "group.opera-e0-ksMeta-000-yz.FENGCHAO.all"},
            {"1.opera-aladdin-ksearch-000-bj.FENGCHAO.dbl", "group.opera-aladdin-ksMeta-000-bj.FENGCHAO.all"},
            {"group.opera-aladdin-ksearch-000-nj.FENGCHAO.all", "group.opera-aladdin-ksMeta-000-bj.FENGCHAO.all"},
            {"7.opera-aladdin-ksStore-000-mix.FENGCHAO.gzhxy", "group.opera-aladdin-ksMeta-000-bj.FENGCHAO.all"},
            {"0.opera-hmkv-ksStore-000-bdnew.FENGCHAO.bddwd", "group.opera-holmes-ksMeta-000-yq.FENGCHAO.all"},
            {"55.opera-hm-ksStore-000-bd.FENGCHAO.bddwd", "group.opera-holmes-ksMeta-000-yq.FENGCHAO.all"},
            {"group.opera-hm-ksStore-000-bd.FENGCHAO.all.serv", "group.opera-holmes-ksMeta-000-yq.FENGCHAO.all"},
            {"1.opera-adp-ksBinlog-000-bj.FENGCHAO.bjhw", "group.opera-ps-ksMeta-000-bj.FENGCHAO.all"},
            {"group.opera-adp-ksBinlog-000-bj.FENGCHAO.all", "group.opera-ps-ksMeta-000-bj.FENGCHAO.all"},
            {"0.opera-sandbox-ksStore-000-bd.FENGCHAO.bddwd", "group.opera-pap-ksMeta-000-bj.FENGCHAO.all"},
        };
    ...
    TEST(brpc_http_get_info_test_db, case_all) {
        ...
        static std::string query_item =
                "&items=matrix.cpu_used_percent,matrix.cpu_quota,matrix.cpu_used,matrix.disk_home_quota_mb,matrix.disk_home_used_mb&ttype=instance";
        static std::set<std::string> test_instance_names = {
            "45.opera-xinghe2-ksStore-000-bj.DMP.bjhw",
            "1.opera-aladdin-ksearch-000-bj.FENGCHAO.dbl",
            "85.opera-hm-ksStore-000-yq.FENGCHAO.yq013"
        };
    ...
    TEST(test_valid_ip, case_all) {
        ...
        EXPECT_EQ(false, is_valid_ip("group.opera-e0-ksearch-000-yz.FENGCHAO.all"));
    }
} // namespace ks