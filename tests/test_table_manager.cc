...
protected:
    virtual void SetUp() {
        ...
        _query_table_manager = ksearch::QueryTableManager::get_instance();
    ...
    ksearch::QueryTableManager *_query_table_manager;
...
TEST_F(TableManagerTest, test_create_drop_modify) {
    ...
    query_request.set_op_type(ksearch::pb::QUERY_SCHEMA);
    ...
    ksearch::pb::MetaManagerRequest update_byte_size_request;
    update_byte_size_request.set_op_type(ksearch::pb::OP_UPDATE_BYTE_SIZE);
    ...
    // 测试点: update_charset
    ksearch::pb::MetaManagerRequest update_charset_request;
    update_charset_request.set_op_type(ksearch::pb::OP_UPDATE_CHARSET);
    ...
    update_charset_request.mutable_table_info()->set_charset(ksearch::pb::GBK);
...
int main(int argc, char **argv) {
    ksearch::FLAGS_db_path = "table_manager_db";
