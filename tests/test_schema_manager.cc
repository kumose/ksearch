...
protected:
    virtual void SetUp() {
        ksearch::RocksWrapper *rocksdb = ksearch::RocksWrapper::get_instance();
        if (!rocksdb) {
        ...
        _cluster_manager = new ksearch::ClusterManager(NULL);
        _schema_manager = new ksearch::SchemaManager(NULL);
...
TEST_F(SchemaManagerTest, test_create_drop_modify) {
    //测试点：添加region
    ksearch::pb::MetaManagerRequest request_update_region_fc;
    request_update_region_fc.set_op_type(ksearch::pb::OP_UPDATE_REGION);
    ...
    request_update_region_fc.mutable_region_info()->set_status(ksearch::pb::IDLE);
    ...
    ksearch::pb::MetaManagerRequest request_split_region_fc;
    ...
    ksearch::pb::MetaManagerRequest request_drop_database;
    request_drop_database.set_op_type(ksearch::pb::OP_DROP_DATABASE);
    ...
    ksearch::pb::MetaManagerRequest request_drop_namespace;
    request_drop_namespace.set_op_type(ksearch::pb::OP_DROP_NAMESPACE);
    ...
    ksearch::pb::MetaManagerRequest request_drop_level_table_fc;
    request_drop_level_table_fc.set_op_type(ksearch::pb::OP_DROP_TABLE);
    ...
    //为后续测试准备数据
    //feed库新建userinfo表
    ksearch::pb::MetaManagerRequest request_create_table_feed;
    request_create_table_feed.set_op_type(ksearch::pb::OP_CREATE_TABLE);
    ...
    //添加region
    ksearch::pb::MetaManagerRequest request_update_region_feed;
    request_update_region_feed.set_op_type(ksearch::pb::OP_UPDATE_REGION);
    ...
    request_update_region_feed.mutable_region_info()->set_status(ksearch::pb::IDLE);
    ...
    ksearch::pb::MetaManagerRequest request_split_region_feed;
    ...
    //测试点：修改表名
    ksearch::pb::MetaManagerRequest rename_table_request;
    rename_table_request.set_op_type(ksearch::pb::OP_RENAME_TABLE);
    ...
    //测试点：add_field
    ksearch::pb::MetaManagerRequest add_field_request;
    add_field_request.set_op_type(ksearch::pb::OP_ADD_FIELD);
    field = add_field_request.mutable_table_info()->add_fields();
    field->set_field_name("isdel");
    field->set_mysql_type(ksearch::pb::BOOL);
    ...
    //测试点：drop_field
    ksearch::pb::MetaManagerRequest drop_field_request;
    drop_field_request.set_op_type(ksearch::pb::OP_DROP_FIELD);
    ...
    //测试点：rename_field
    ksearch::pb::MetaManagerRequest rename_field_request;
    rename_field_request.set_op_type(ksearch::pb::OP_RENAME_FIELD);
...
int main(int argc, char **argv) {
    ksearch::FLAGS_db_path = "schema_manager_db";
