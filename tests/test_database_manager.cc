...
protected:
    ...
    ksearch::QueryDatabaseManager *_query_database_manager;
...
TEST_F(DatabaseManagerTest, test_create_drop_modify) {
    ...
    ksearch::pb::MetaManagerRequest request_modify_database_fc;
    request_modify_database_fc.set_op_type(ksearch::pb::OP_MODIFY_DATABASE);
    ...
    query_request.set_op_type(ksearch::pb::QUERY_DATABASE);
...
int main(int argc, char **argv) {
    ksearch::FLAGS_db_path = "database_manager_db";
