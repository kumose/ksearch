...
protected:
    virtual void SetUp() {
        ...
        _query_namespace_manager = ksearch::QueryNamespaceManager::get_instance();
    ...
    ksearch::QueryNamespaceManager *_query_namespace_manager;
...
TEST_F(NamespaceManagerTest, test_create_drop_modify) {
    ...
    ksearch::pb::MetaManagerRequest request_modify_namespace_feed;
    request_modify_namespace_feed.set_op_type(ksearch::pb::OP_MODIFY_NAMESPACE);
    ...
    query_request.set_op_type(ksearch::pb::QUERY_NAMESPACE);
...
int main(int argc, char **argv) {
    ksearch::FLAGS_db_path = "namespace_manager_db";
