...
TEST_F(TestManagerTest, test_create_drop_modify) {
    ...
    region_info->set_status(ksearch::pb::IDLE);
    ...
    //}
    //split_region
    ksearch::pb::MetaManagerRequest split_region_request;
    split_region_request.set_op_type(ksearch::pb::OP_SPLIT_REGION);
    ...
    //drop_region
    ksearch::pb::MetaManagerRequest drop_region_request;
    drop_region_request.set_op_type(ksearch::pb::OP_DROP_REGION);
...
int main(int argc, char **argv) {
    ksearch::FLAGS_db_path = "region_manager_db";
