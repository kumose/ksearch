...
namespace ksearch {
        ...
        */
            ...
            std::vector<arrow::compute::Expression> exprs = {
                ...
                arrow::compute::call("case_when", {
                                         arrow::compute::call("make_struct", {
                                                                  arrow::compute::call("equal", {
                                                                      arrow::compute::field_ref("prod_line_id_3"),
                                                                      arrow::compute::literal(101001)
                                                                  }),
                                                                  arrow::compute::call("equal", {
                                                                      arrow::compute::field_ref("prod_line_id_3"),
                                                                      arrow::compute::literal(101002)
                                                                  }),
                                                                  arrow::compute::call("equal", {
                                                                      arrow::compute::field_ref("prod_line_id_3"),
                                                                      arrow::compute::literal(101003)
                                                                  }),
                                                                  arrow::compute::call("equal", {
                                                                      arrow::compute::field_ref("prod_line_id_3"),
                                                                      arrow::compute::literal(101004)
                                                                  }),
                                                                  arrow::compute::call("equal", {
                                                                      arrow::compute::field_ref("prod_line_id_3"),
                                                                      arrow::compute::literal(101005)
                                                                  }),
                                                              }),
            ...
            std::vector<std::string> names = {
                "0_9", "0_2", "0_3", "0_4", "0_5", "1_1", "1_2", "1_3", "prod_line_name_3", "monitor_product_name"
            };
            auto declaration = arrow::acero::Declaration::Sequence({
                {"table_source", arrow::acero::TableSourceNodeOptions(table, 5)},
    ...
    struct test_string_cast_same_with_row {
        ...
        static void test(std::string func_name, std::shared_ptr<arrow::Array> &input_array,
            ...
            for (int64_t i = 0; i < output_data.length(); ++i) {
                ...
                CType actual = *(data + i);
                std::cout << "row: " << i << ", str: " << row_values[i].str_val << ", expect: " << expect <<
    ...
    TEST(test_string_cast_numberic, case_all) {
        EXPECT_TRUE(ksearch::ArrowFunctionManager::instance()->RegisterAllArrowFunction() == 0);
