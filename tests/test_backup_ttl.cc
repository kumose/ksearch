...
namespace ksearch {
    ...
    TEST(backup_ttl, one_level_backup_ttl) {
        ksearch::BackUp bp("127.0.0.1:8110", "e0", 1, 3, 0, 0);
        {
    ...
    TEST(backup_ttl, two_level_backup_ttl_weekly) {
        ksearch::BackUp bp("127.0.0.1:8110", "e0", 1, 3, 7, 4);
        {
            std::vector<RegionFile> region_files;
            generate_sst_info(region_files, {"20230101", "20230102"});
            bp.ttl_backup_ssts("20230104", region_files);
        ...
        {
            std::vector<RegionFile> region_files;
            generate_sst_info(region_files, {
                                  "20230101", "20230108", "20230115", "20230122", "20230129", "20230130", "20230131",
                                  "20230201"
                              });
        ...
        }
        {
            std::vector<RegionFile> region_files;
            generate_sst_info(region_files, {
                                  "20230115", "20230122", "20230129", "20230205", "20230212", "20230213", "20230214"
                              });
        ...
        }
        {
            std::vector<RegionFile> region_files;
            generate_sst_info(region_files, {
                                  "20231210", "20231217", "20231224", "20231231", "20240101", "20240102", "20240103"
                              });
        ...
        }
        {
            std::vector<RegionFile> region_files;
            generate_sst_info(region_files, {
                                  "20230829", "20230905", "20230912", "20230919", "20230924", "20230926", "20230929",
                                  "20231008", "20231009", "20231012"
                              });
