...
#include <ksearch/meta_server/auto_incr_state_machine.h>
...
protected:
    virtual void SetUp() {
        ...
        _auto_incr = new ksearch::AutoIncrStateMachine(peer_id);
    }

    virtual void TearDown() {
    }

    ksearch::AutoIncrStateMachine *_auto_incr;
};

// add_logic add_physical add_instance
TEST_F(AutoIncrStateMachineTest, test_create_drop_modify) {
    //test_point: add_table
    ksearch::pb::MetaManagerRequest add_table_id_request;
    add_table_id_request.set_op_type(ksearch::pb::OP_ADD_ID_FOR_AUTO_INCREMENT);
    ...
    //test_point: gen_id
    ksearch::pb::MetaManagerRequest gen_id_request;
    gen_id_request.set_op_type(ksearch::pb::OP_GEN_ID_FOR_AUTO_INCREMENT);
    ...
    //test_point: update
    ksearch::pb::MetaManagerRequest update_id_request;
    update_id_request.set_op_type(ksearch::pb::OP_UPDATE_FOR_AUTO_INCREMENT);
    ...
    ksearch::pb::MetaManagerRequest drop_id_request;
    drop_id_request.set_op_type(ksearch::pb::OP_DROP_ID_FOR_AUTO_INCREMENT);
