...
#include <ksearch/common/cmsketch.h>
#include <ksearch/common/histogram.h>
#include <ksearch/common/tuple_record.h>
#include <vector>
...
DEFINE_string(
    test_tuple,
    "",
    "num");
...
int main(int argc, char *argv[]) {
...

    {
        ...
        ksearch::CMsketchColumn column(FLAGS_test_depth, FLAGS_test_width, 1);
        for (int i = 0; i < size; i++) {
            ksearch::ExprValue value;
            value.type = ksearch::pb::INT32;
            value._u.int32_val = i;
            column.set_value(value.hash(), 1);
        }

        ksearch::ExprValue value_o;
        value_o.type = ksearch::pb::INT32;
        value_o._u.int32_val = FLAGS_test_value;
        int cnt = column.get_value(value_o.hash());
        DB_WARNING("0 size:%d, depth:%d, width:%d, get_value:%d, cnt:%d", size, column.get_depth(), column.get_width(),
                   value_o._u.int32_val, cnt);
    }
    {
        ...
        ksearch::TupleRecord tuple_record(slice1);
        ...
        ksearch::TupleRecord tuple_record2(slice1);
    ...
    {
        ksearch::Histogram h(ksearch::pb::INT32, 1, 2, 0);
        ksearch::ExprValue value;
        value.type = ksearch::pb::INT32;
        value._u.int32_val = 1;
        ksearch::TEST_insert_value(value, false, h.get_bucket_mapping());
        value._u.int32_val = 1;
        ksearch::TEST_insert_value(value, false, h.get_bucket_mapping());

        value._u.int32_val = 2;
        ksearch::TEST_insert_value(value, true, h.get_bucket_mapping());
        value._u.int32_val = 2;
        ksearch::TEST_insert_value(value, false, h.get_bucket_mapping());
    ...
    {
        ksearch::Histogram h(ksearch::pb::INT64, 1, 2, 0);
        ksearch::ExprValue value;
        value.type = ksearch::pb::INT64;
    ...
    {
        ksearch::Histogram h(ksearch::pb::UINT32, 1, 2, 0);
        ksearch::ExprValue value;
        value.type = ksearch::pb::UINT32;
    ...
    {
        ksearch::Histogram h(ksearch::pb::UINT64, 1, 2, 0);
        ksearch::ExprValue value;
        value.type = ksearch::pb::UINT64;
    ...
    {
        ksearch::Histogram h(ksearch::pb::STRING, 1, 2, 0);
        ksearch::ExprValue value;
        value.type = ksearch::pb::STRING;
        value.str_val = "a";
        ksearch::TEST_insert_value(value, false, h.get_bucket_mapping());
        value.str_val = "a";
        ksearch::TEST_insert_value(value, false, h.get_bucket_mapping());
...

    {
        ...
        ksearch::ExprValue lower_value;
        ksearch::ExprValue upper_value;
        upper_value.type = ksearch::pb::INT32;
        ...
        lower_value.type = ksearch::pb::INT32;
        lower_value._u.int32_val = 400;
        upper_value.type = ksearch::pb::NULL_TYPE;
