...
namespace ksearch {
    namespace tdigest {
        ...
        TEST(test_tdigest_expr_value, case_all) {
            ...
            std::cout << " cast_to t_digest size: " << td_val.str_val.size() << " compressed size: " << td_val.
                    get_string().size() << std::endl;
            ...
            std::cout << "t_digest size: " << td_val.str_val.size() << " compressed size: " << td_val.get_string().
                    size() << std::endl;
            std::cout << "percentile 95%: " << tdigest::td_quantile_of(t, 120.0) << std::endl;
            std::cout << "percentile 95 val: " << tdigest::td_value_at(t, 0.95) << std::endl;
        }
